...
int main() {
    ...
    a.mov(x86::dword_ptr(x86::rbp, -8), x86::eax); // local c :=
    a.mov(x86::eax, x86::dword_ptr(x86::rbp, -8)); // local c
    ...
    a.pop(x86::rax);
    a.add(x86::eax, x86::ebx);
    a.mov(x86::dword_ptr(x86::rbp, -16), x86::eax); // local d :=
    a.mov(x86::eax, x86::dword_ptr(x86::rbp, -16)); // local d
    a.mov(x86::rbx, x86::qword_ptr(x86::rbp, -8));
    a.mov(x86::rsp, x86::rbp);
    a.pop(x86::rbp);
    a.ret();
    ...
    labels.add("L0", "func_Add_1");
    labels.add("L1", "endfunc_Add_2");
    labels.add("L2", "func_Add_Add2_3");
    labels.add("L3", "endfunc_Add_Add2_4");
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test13.asm" << std::endl;
    }
