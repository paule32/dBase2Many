...
int main() {
    ...
    a.mov(x86::dword_ptr(x86::rax, 0), x86::ebx); // c
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, int_vars)));
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 0)); // c
    ...
    a.mov(x86::ebx, x86::eax);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, int_vars)));
    a.mov(x86::dword_ptr(x86::rax, 4), x86::ebx); // d
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, int_vars)));
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 4)); // d
    a.mov(x86::rsp, x86::rbp);
    a.pop(x86::rbp);
    a.ret();
