...
static const char str_0[] = "pp";
static const char str_1[] = "Nil pointer error: pp";
...
int main() {
    ...
    a.mov(x86::dword_ptr(x86::rax), x86::ebx); // pp^.X :=
    a.mov(x86::eax, 20);
    a.mov(x86::ebx, x86::eax);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // pp
    ...
    a.mov(x86::dword_ptr(x86::rax), x86::ebx); // pp^.Y :=
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // pp
    ...
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 0)); // pp.X
    ...
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 4)); // pp.Y
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&_jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    asm_out << "record_vars: times 8 db 0\n";
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"pp\", 0\n";
    asm_out << "_str_1 db \"Nil pointer error: pp\", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test23.asm" << std::endl;
    }
