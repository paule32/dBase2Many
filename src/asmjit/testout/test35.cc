...
static const char str_2[] = "Head";
static const char str_3[] = "Nil pointer error: Head";
static const char str_4[] = "p";
static const char str_5[] = "Nil pointer error: p";
...
int main() {
    ...
    Label proc_Pop_5 = a.new_label();
    Label skipproc_Pop_6 = a.new_label();
    Label exitproc_Pop_7 = a.new_label();
    a.jmp(skipproc_Pop_6);
    a.bind(proc_Pop_5);
    a.push(x86::rbp);
    a.mov(x86::rbp, x86::rsp);
    a.push(x86::rcx); // save param Head
    ...
    a.sub(x86::rsp, 512); // local variables
    Label else_8 = a.new_label();
    Label endif_9 = a.new_label();
    a.mov(x86::r11, x86::qword_ptr(x86::rbp, -8)); // var param address Head
    a.mov(x86::rax, x86::qword_ptr(x86::r11));
    ...
    a.jne(else_8);
    a.jmp(exitproc_Pop_7); // Exit
    a.bind(else_8);
    a.mov(x86::r11, x86::qword_ptr(x86::rbp, -8)); // var param address Head
    a.mov(x86::rax, x86::qword_ptr(x86::r11));
    a.mov(x86::qword_ptr(x86::rbp, -16), x86::rax); // local pointer tmp :=
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // Head
    Label ptr_not_nil_10 = a.new_label();
    a.test(x86::rax, x86::rax);
    a.jnz(ptr_not_nil_10);
    a.mov(x86::rcx, imm((uint64_t)str_3));
    a.mov(x86::rax, imm((uint64_t)&_jit_runtime_error));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.bind(ptr_not_nil_10);
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 4)); // Head.Next
    a.mov(x86::r11, x86::qword_ptr(x86::rbp, -8)); // var param address Head
    a.mov(x86::qword_ptr(x86::r11), x86::rax);
    a.mov(x86::rax, x86::qword_ptr(x86::rbp, -16)); // local pointer tmp
    ...
    a.mov(x86::qword_ptr(x86::rbp, -16), x86::rax); // local pointer tmp :=
    a.bind(exitproc_Pop_7);
    a.mov(x86::rsp, x86::rbp);
    a.pop(x86::rbp);
    a.ret();
    a.bind(skipproc_Pop_6);
    a.push(x86::r12);
    a.push(x86::rbx);
    ...
    Label while_11 = a.new_label();
    Label endwhile_12 = a.new_label();
    a.bind(while_11);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    ...
    labels.add("L4", "proc_Pop_5");
    labels.add("L5", "skipproc_Pop_6");
    labels.add("L6", "exitproc_Pop_7");
    labels.add("L7", "else_8");
    labels.add("L8", "endif_9");
    labels.add("L9", "ptr_not_nil_10");
    labels.add("L10", "while_11");
    labels.add("L11", "endwhile_12");
    ...
    asm_out << "_str_2 db \"Head\", 0\n";
    asm_out << "_str_3 db \"Nil pointer error: Head\", 0\n";
    asm_out << "_str_4 db \"p\", 0\n";
    asm_out << "_str_5 db \"Nil pointer error: p\", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test35.asm" << std::endl;
    }
