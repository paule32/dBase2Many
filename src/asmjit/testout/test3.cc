...
static const char str_1[] = "x ist groesser als 10";
static const char str_2[] = "x ist kleiner oder gleich 10";
static const char str_3[] = "d ist kleiner als 20";
static const char str_4[] = "ende";
...
int main() {
    ...
    replace_all(asm_text, std::to_string(_double_to_bits(20.0)), "dbl_20_0_1");
    asm_out << std::endl;
    asm_out << std::endl;
    
    asm_out << "dbl_10_5_0 equ " << std::to_string(_double_to_bits(10.5)) << " ; 10.5\n";
    asm_out << "dbl_20_0_1 equ " << std::to_string(_double_to_bits(20.0)) << " ; 20.0\n";
    ...
    asm_out << "_str_1 db \"x ist groesser als 10\", 0\n";
    asm_out << "_str_2 db \"x ist kleiner oder gleich 10\", 0\n";
    asm_out << "_str_3 db \"d ist kleiner als 20\", 0\n";
    asm_out << "_str_4 db \"ende\", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test3.asm" << std::endl;
    }
