...
int main() {
    ...
    Label func_IsOk_1 = a.new_label();
    Label endfunc_IsOk_2 = a.new_label();
    a.jmp(endfunc_IsOk_2);
    a.bind(func_IsOk_1);
    a.push(x86::rbp);
    ...
    a.pop(x86::rbp);
    a.ret();
    a.bind(endfunc_IsOk_2);
    Label func_IsNotOk_3 = a.new_label();
    Label endfunc_IsNotOk_4 = a.new_label();
    a.jmp(endfunc_IsNotOk_4);
    a.bind(func_IsNotOk_3);
    a.push(x86::rbp);
    a.mov(x86::rbp, x86::rsp);
    a.push(x86::rbx); // preserve non-volatile RBX
    a.sub(x86::rsp, 8); // align stack in function
    ...
    labels.add("L0", "func_IsOk_1");
    labels.add("L1", "endfunc_IsOk_2");
    labels.add("L2", "func_IsNotOk_3");
    labels.add("L3", "endfunc_IsNotOk_4");
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test41.asm" << std::endl;
    }
