...
int main() {
    ...
    asm_out << "arrays_vars: times 16 db 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test43.asm" << std::endl;
    }
    ...
    std::array<uint8_t,  16> arrays_vars{};
