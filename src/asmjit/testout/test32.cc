...
int main() {
    ...
    a.push(x86::rcx); // save param Value
    ...
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.mov(x86::qword_ptr(x86::rbp, -16), x86::rax); // local pointer n :=
    a.mov(x86::eax, x86::dword_ptr(x86::rbp, -8));
    a.mov(x86::ebx, x86::eax);
    a.mov(x86::rax, x86::qword_ptr(x86::rbp, -16)); // local pointer n
    ...
    Label while_5 = a.new_label();
    Label endwhile_6 = a.new_label();
    a.bind(while_5);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    ...
    labels.add("L4", "while_5");
    labels.add("L5", "endwhile_6");
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test32.asm" << std::endl;
    }
