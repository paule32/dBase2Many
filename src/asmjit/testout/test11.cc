...
int main() {
    ...
    labels.add("L0", "func_Add1_1");
    labels.add("L1", "endfunc_Add1_2");
    labels.add("L2", "func_Add2_3");
    labels.add("L3", "endfunc_Add2_4");
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test11.asm" << std::endl;
    }
