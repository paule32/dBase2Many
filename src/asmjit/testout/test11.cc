...
static const char str_0[] = "Add1 result: ";
static const char str_1[] = "Add2 result: ";
...
int main() {
    ...
    Label func_Add1_1 = a.new_label();
    Label endfunc_Add1_2 = a.new_label();
    a.jmp(endfunc_Add1_2);
    a.bind(func_Add1_1);
    a.push(x86::rbp);
    ...
    a.pop(x86::rbp);
    a.ret();
    a.bind(endfunc_Add1_2);
    Label func_Add2_3 = a.new_label();
    Label endfunc_Add2_4 = a.new_label();
    a.jmp(endfunc_Add2_4);
    a.bind(func_Add2_3);
    a.push(x86::rbp);
    a.mov(x86::rbp, x86::rsp);
    a.push(x86::rcx); // save function param a
    ...
    std::ofstream asm_out("test11.asm");
    ...
    replace_all(asm_text, "L0:", "func_Add1_1:");
    replace_all(asm_text, "L0", "func_Add1_1");
    replace_all(asm_text, "L1:", "endfunc_Add1_2:");
    replace_all(asm_text, "L1", "endfunc_Add1_2");
    replace_all(asm_text, "L2:", "func_Add2_3:");
    replace_all(asm_text, "L2", "func_Add2_3");
    replace_all(asm_text, "L3:", "endfunc_Add2_4:");
    replace_all(asm_text, "L3", "endfunc_Add2_4");
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"Add1 result: \", 0\n";
    asm_out << "_str_1 db \"Add2 result: \", 0\n";
