...
int main() {
    ...
    a.mov(x86::rax, imm(_double_to_bits(3.1415926)));
    ...
    a.sub(x86::rsp, 8); // align stack in function
    a.sub(x86::rsp, 256); // local variables
    a.mov(x86::rax, imm(_double_to_bits(12.34)));
    a.movq(x86::xmm0, x86::rax);
    a.mov(x86::rbx, x86::qword_ptr(x86::rbp, -8));
    a.mov(x86::rsp, x86::rbp);
    a.pop(x86::rbp);
    ...
    replace_all(asm_text, std::to_string(_double_to_bits(3.1415926)), "dbl_3_1415926_0");
    replace_all(asm_text, std::to_string(_double_to_bits(12.34)), "dbl_12_34_1");
    asm_out << std::endl;
    asm_out << std::endl;
    
    asm_out << "dbl_3_1415926_0 equ " << std::to_string(_double_to_bits(3.1415926)) << " ; 3.1415926\n";
    asm_out << "dbl_12_34_1 equ " << std::to_string(_double_to_bits(12.34)) << " ; 12.34\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test15.asm" << std::endl;
    }
