...
int main() {
    ...
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // dynamic array Points
    ...
    a.mov(x86::qword_ptr(x86::r11, 0), x86::rax); // dynamic array Points
    a.mov(x86::eax, 100);
    a.mov(x86::dword_ptr(x86::r12, offsetof(JitContext, print_int_tmp)), x86::eax);
    a.mov(x86::eax, 0);
    a.mov(x86::r10d, x86::eax); // dynamic record array index
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // dynamic array Points
    a.movsxd(x86::r11, x86::r10d);
    a.imul(x86::r11, x86::r11, 8);
    a.add(x86::r11, x86::rax); // record element address
    a.mov(x86::eax, x86::dword_ptr(x86::r12, offsetof(JitContext, print_int_tmp)));
    a.mov(x86::dword_ptr(x86::r11, 0), x86::eax);
    a.mov(x86::eax, 200);
    a.mov(x86::dword_ptr(x86::r12, offsetof(JitContext, print_int_tmp)), x86::eax);
    a.mov(x86::eax, 0);
    a.mov(x86::r10d, x86::eax); // dynamic record array index
    ...
    a.add(x86::r11, x86::rax); // record element address
    a.mov(x86::eax, x86::dword_ptr(x86::r12, offsetof(JitContext, print_int_tmp)));
    a.mov(x86::dword_ptr(x86::r11, 4), x86::eax);
    a.mov(x86::eax, 0);
    a.mov(x86::r10d, x86::eax); // dynamic record array index
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // dynamic array Points
    ...
    a.imul(x86::r11, x86::r11, 8);
    a.add(x86::r11, x86::rax); // record element address
    a.mov(x86::eax, x86::dword_ptr(x86::r11, 0));
    ...
    a.imul(x86::r11, x86::r11, 8);
    a.add(x86::r11, x86::rax); // record element address
    a.mov(x86::eax, x86::dword_ptr(x86::r11, 4));
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&_jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test39.asm" << std::endl;
    }
