...
int main() {
    ...
    a.mov(x86::eax, 10);
    a.push(x86::rax);
    a.mov(x86::rax, imm(_double_to_bits(20.214)));
    ...
    replace_all(asm_text, std::to_string(_double_to_bits(20.214)), "dbl_20_214_0");
    replace_all(asm_text, std::to_string(_double_to_bits(20.214)), "dbl_20_214_1");
    asm_out << std::endl;
    asm_out << std::endl;
    
    asm_out << "dbl_20_214_0 equ " << std::to_string(_double_to_bits(20.214)) << " ; 20.214\n";
    asm_out << "dbl_20_214_1 equ " << std::to_string(_double_to_bits(20.214)) << " ; 20.214\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test2.asm" << std::endl;
    }
