...
int main() {
    ...
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 0)); // n1.Value
    ...
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 4)); // follow pointer Next
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 0)); // n1.Next.Value
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&_jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test30.asm" << std::endl;
    }
