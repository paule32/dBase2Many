...
int main() {
    ...
    Label proc_InsertAfter_4 = a.new_label();
    Label skipproc_InsertAfter_5 = a.new_label();
    Label exitproc_InsertAfter_6 = a.new_label();
    a.jmp(skipproc_InsertAfter_5);
    a.bind(proc_InsertAfter_4);
    a.push(x86::rbp);
    a.mov(x86::rbp, x86::rsp);
    a.push(x86::rcx); // save param Head
    ...
    Label while_7 = a.new_label();
    Label endwhile_8 = a.new_label();
    a.bind(while_7);
    ...
    a.je(endwhile_8);
    Label else_9 = a.new_label();
    Label endif_10 = a.new_label();
    a.mov(x86::rax, x86::qword_ptr(x86::rbp, -32)); // local pointer p
    ...
    a.jmp(exitproc_InsertAfter_6); // Exit
    a.bind(else_9);
    a.mov(x86::rax, x86::qword_ptr(x86::rbp, -32)); // local pointer p
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 4)); // p.Next
    a.mov(x86::qword_ptr(x86::rbp, -32), x86::rax); // local pointer p :=
    a.jmp(while_7);
    a.bind(endwhile_8);
    a.bind(exitproc_InsertAfter_6);
    a.mov(x86::rsp, x86::rbp);
    a.pop(x86::rbp);
    a.ret();
    a.bind(skipproc_InsertAfter_5);
    a.push(x86::r12);
    a.push(x86::rbx);
    ...
    std::ofstream asm_out("test37.asm");
    ...
    labels.add("L3", "proc_InsertAfter_4");
    labels.add("L4", "skipproc_InsertAfter_5");
    labels.add("L5", "exitproc_InsertAfter_6");
    labels.add("L6", "while_7");
    labels.add("L7", "endwhile_8");
    labels.add("L8", "else_9");
    labels.add("L9", "endif_10");
