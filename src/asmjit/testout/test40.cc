...
int main() {
    ...
    a.mov(x86::dword_ptr(x86::rax, 0), x86::ebx); // a
    a.mov(x86::eax, 0);
    a.mov(x86::ebx, x86::eax);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, int_vars)));
    a.mov(x86::dword_ptr(x86::rax, 4), x86::ebx); // b
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, int_vars)));
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 0)); // a
    a.cmp(x86::eax, 0);
    a.setne(x86::al);
    a.movzx(x86::eax, x86::al);
    a.push(x86::rax);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, int_vars)));
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 4)); // b
    a.cmp(x86::eax, 0);
    a.setne(x86::al);
    a.movzx(x86::eax, x86::al);
    a.pop(x86::rbx);
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test40.asm" << std::endl;
    }
