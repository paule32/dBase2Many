...
static const char str_0[] = "Hallo Welt";
static const char str_1[] = "Welt";
static const char str_2[] = "abc";
...
int main() {
    ...
    a.push(x86::rax); // Copy source
    a.mov(x86::eax, 1);
    a.movsxd(x86::rax, x86::eax);
    a.push(x86::rax); // Copy start
    a.mov(x86::eax, 5);
    a.movsxd(x86::rax, x86::eax);
    a.push(x86::rax); // Copy count
    a.pop(x86::r8);
    a.pop(x86::rdx);
    a.pop(x86::rcx);
    a.sub(x86::rsp, 32);
    a.mov(x86::rax, imm((uint64_t)&_jit_dynstring_copy));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.add(x86::rsp, 32);
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, string_vars)));
    a.mov(x86::qword_ptr(x86::r11, 8), x86::rax); // t
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, string_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 8)); // t
    a.mov(x86::rcx, x86::rax);
    ...
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.push(x86::rax); // Pos needle
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, string_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // s
    a.push(x86::rax); // Pos haystack
    a.pop(x86::rdx);
    a.pop(x86::rcx);
    a.sub(x86::rsp, 32);
    a.mov(x86::rax, imm((uint64_t)&_jit_dynstring_pos));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.add(x86::rsp, 32);
    ...
    a.mov(x86::dword_ptr(x86::rax, 0), x86::ebx); // p
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, int_vars)));
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 0)); // p
    ...
    asm_out << "string_vars: times 2 dq 0\n";
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"Hallo Welt\", 0\n";
    asm_out << "_str_1 db \"Welt\", 0\n";
    asm_out << "_str_2 db \"abc\", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test51.asm" << std::endl;
    }
    
    std::array<int,      1> int_vars{};
    std::array<double,   1> double_vars{};
    std::array<char*,    2> string_vars{};
