...
static const char str_0[] = "points";
static const char str_1[] = "points";
static const char str_2[] = "points";
static const char str_3[] = "points";
...
int main() {
    ...
    a.mov(x86::dword_ptr(x86::r11), x86::eax); // points[...].X :=
    a.mov(x86::eax, 20);
    a.mov(x86::dword_ptr(x86::r12, offsetof(JitContext, print_int_tmp)), x86::eax);
    a.mov(x86::eax, 0);
    ...
    a.add(x86::r11, 4);
    a.mov(x86::eax, x86::dword_ptr(x86::r12, offsetof(JitContext, print_int_tmp)));
    a.mov(x86::dword_ptr(x86::r11), x86::eax); // points[...].Y :=
    a.mov(x86::eax, 0);
    ...
    a.movsxd(x86::rax, x86::eax);
    a.add(x86::r11, x86::rax);
    a.mov(x86::eax, x86::dword_ptr(x86::r11)); // points[...].X
    ...
    a.add(x86::r11, x86::rax);
    a.add(x86::r11, 4);
    a.mov(x86::eax, x86::dword_ptr(x86::r11)); // points[...].Y
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    std::ofstream asm_out("test24.asm");
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"points\", 0\n";
    asm_out << "_str_1 db \"points\", 0\n";
    asm_out << "_str_2 db \"points\", 0\n";
    asm_out << "_str_3 db \"points\", 0\n";
    ...
    std::array<uint8_t,     80> arrays_vars{};
