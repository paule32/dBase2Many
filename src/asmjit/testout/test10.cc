...
static const char str_0[] = "Function result: ";
...
int main() {
    ...
    Label func_GetValue_1 = a.new_label();
    Label endfunc_GetValue_2 = a.new_label();
    a.jmp(endfunc_GetValue_2);
    a.bind(func_GetValue_1);
    a.push(x86::rbp);
    ...
    labels.add("L0", "func_GetValue_1");
    labels.add("L1", "endfunc_GetValue_2");
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"Function result: \", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test10.asm" << std::endl;
    }
