...
static const char str_0[] = "Before nil access";
static const char str_1[] = "P";
static const char str_2[] = "Nil pointer error: P";
static const char str_3[] = "After nil access";
...
int main() {
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"Before nil access\", 0\n";
    asm_out << "_str_1 db \"P\", 0\n";
    asm_out << "_str_2 db \"Nil pointer error: P\", 0\n";
    asm_out << "_str_3 db \"After nil access\", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test46.asm" << std::endl;
    }
