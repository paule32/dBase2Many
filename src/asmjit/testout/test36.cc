...
int main() {
    ...
    a.push(x86::rcx); // save param a
    a.push(x86::rdx); // save param b
    a.push(x86::r8); // save param c
    a.push(x86::r9); // save param d
    ...
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.mov(x86::eax, x86::dword_ptr(x86::rbp, 48)); // load integer parameter
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.mov(x86::eax, x86::dword_ptr(x86::rbp, 56)); // load integer parameter
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.mov(x86::eax, x86::dword_ptr(x86::rbp, 64)); // load integer parameter
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.mov(x86::eax, x86::dword_ptr(x86::rbp, 72)); // load integer parameter
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    a.push(x86::rax); // stack integer parameter
    a.mov(x86::eax, 7);
    a.movsxd(x86::rax, x86::eax);
    a.push(x86::rax); // stack integer parameter
    a.mov(x86::eax, 6);
    ...
    a.call(proc_Test_1);
    a.add(x86::rsp, 32);
    a.add(x86::rsp, 32); // remove stack parameters
    ...
    std::ofstream asm_out("test36.asm");
