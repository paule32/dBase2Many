...
int main() {
    ...
    a.push(x86::rcx); // save param ListHead
    ...
    a.mov(x86::r11, x86::qword_ptr(x86::rbp, -8)); // var param address ListHead
    ...
    std::ofstream asm_out("test33.asm");
    ...
    std::array<uint64_t,    3> pointr_vars{};
