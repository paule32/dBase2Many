...
static const char str_0[] = "one";
static const char str_1[] = "two";
static const char str_2[] = "three or four";
static const char str_3[] = "other";
...
int main() {
    ...
    Label case_end_1 = a.new_label();
    Label case_else_2 = a.new_label();
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, int_vars)));
    a.mov(x86::eax, x86::dword_ptr(x86::rax, 0)); // i
    a.mov(x86::ebx, x86::eax); // case selector
    Label case_item_0_3 = a.new_label();
    a.cmp(x86::ebx, 1);
    a.je(case_item_0_3);
    Label case_item_1_4 = a.new_label();
    a.cmp(x86::ebx, 2);
    a.je(case_item_1_4);
    Label case_item_2_5 = a.new_label();
    a.cmp(x86::ebx, 3);
    a.je(case_item_2_5);
    a.cmp(x86::ebx, 4);
    a.je(case_item_2_5);
    a.jmp(case_else_2);
    a.bind(case_item_0_3);
    ...
    labels.add("L0", "case_end_1");
    labels.add("L1", "case_else_2");
    labels.add("L2", "case_item_0_3");
    labels.add("L3", "case_item_1_4");
    labels.add("L4", "case_item_2_5");
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"one\", 0\n";
    asm_out << "_str_1 db \"two\", 0\n";
    asm_out << "_str_2 db \"three or four\", 0\n";
    asm_out << "_str_3 db \"other\", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test53.asm" << std::endl;
    }
