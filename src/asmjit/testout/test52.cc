...
static const char str_0[] = "p";
static const char str_1[] = "Nil pointer error: p";
static const char str_2[] = "Fehler";
static const char str_3[] = "OK";
...
int main() {
    ...
    Label and_false_3 = a.new_label();
    Label and_end_4 = a.new_label();
    ...
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // p
    Label ptr_not_nil_5 = a.new_label();
    a.test(x86::rax, x86::rax);
    a.jnz(ptr_not_nil_5);
    ...
    Label cmp_true_6 = a.new_label();
    Label cmp_end_7 = a.new_label();
    a.je(cmp_true_6);
    ...
    labels.add("L2", "and_false_3");
    labels.add("L3", "and_end_4");
    labels.add("L4", "ptr_not_nil_5");
    labels.add("L5", "cmp_true_6");
    labels.add("L6", "cmp_end_7");
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"p\", 0\n";
    asm_out << "_str_1 db \"Nil pointer error: p\", 0\n";
    asm_out << "_str_2 db \"Fehler\", 0\n";
    asm_out << "_str_3 db \"OK\", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test52.asm" << std::endl;
    }
