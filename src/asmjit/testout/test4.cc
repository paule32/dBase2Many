...
int main() {
    ...
    a.mov(x86::rax, imm(_double_to_bits(10.5)));
    ...
    a.mov(x86::rax, imm(_double_to_bits(3.1415)));
    a.movq(x86::xmm0, x86::rax);
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, double_vars)));
    ...
    a.mov(x86::rax, imm(_double_to_bits(20.0)));
    a.movq(x86::xmm0, x86::rax);
    ...
    a.sub(x86::rsp, 8);
    a.movsd(x86::qword_ptr(x86::rsp), x86::xmm0);
    a.mov(x86::rax, imm(_double_to_bits(3.141)));
    a.movq(x86::xmm0, x86::rax);
    a.movapd(x86::xmm1, x86::xmm0);
    a.movsd(x86::xmm0, x86::qword_ptr(x86::rsp));
    a.add(x86::rsp, 8);
    ...
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, double_vars)));
    a.movsd(x86::xmm0, x86::qword_ptr(x86::rax, 8)); // e
    a.mov(x86::rax, imm((uint64_t)&_jit_print_double));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.mov(x86::rax, imm((uint64_t)&_jit_print_newline));
    ...
    replace_all(asm_text, std::to_string(_double_to_bits(10.5)), "dbl_10_5_0");
    replace_all(asm_text, std::to_string(_double_to_bits(3.1415)), "dbl_3_1415_1");
    replace_all(asm_text, std::to_string(_double_to_bits(20.0)), "dbl_20_0_2");
    replace_all(asm_text, std::to_string(_double_to_bits(3.141)), "dbl_3_141_3");
    asm_out << std::endl;
    asm_out << std::endl;
    
    asm_out << "dbl_10_5_0 equ " << std::to_string(_double_to_bits(10.5)) << " ; 10.5\n";
    asm_out << "dbl_3_1415_1 equ " << std::to_string(_double_to_bits(3.1415)) << " ; 3.1415\n";
    asm_out << "dbl_20_0_2 equ " << std::to_string(_double_to_bits(20.0)) << " ; 20.0\n";
    asm_out << "dbl_3_141_3 equ " << std::to_string(_double_to_bits(3.141)) << " ; 3.141\n";
    ...
    asm_out << "int_vars:    times 2 dd 0\n";
    asm_out << "double_vars: times 2 dq 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test4.asm" << std::endl;
    }
