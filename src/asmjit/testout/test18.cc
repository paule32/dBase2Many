...
static const char str_0[] = "rX: ";
static const char str_1[] = "rY: ";
...
int main() {
    ...
    a.mov(x86::dword_ptr(x86::r11, 0), x86::eax); // p.X
    a.mov(x86::eax, 10);
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, record_vars)));
    a.mov(x86::dword_ptr(x86::r11, 8), x86::eax); // r.TopLeft.R1.X
    a.mov(x86::eax, 20);
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, record_vars)));
    a.mov(x86::dword_ptr(x86::r11, 12), x86::eax); // r.TopLeft.R1.Y
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, record_vars)));
    a.mov(x86::eax, x86::dword_ptr(x86::r11, 0)); // p.X
    ...
    a.add(x86::rsp, 32);
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, record_vars)));
    a.mov(x86::eax, x86::dword_ptr(x86::r11, 8)); // r.TopLeft.R1.X
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&_jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    a.add(x86::rsp, 32);
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, record_vars)));
    a.mov(x86::eax, x86::dword_ptr(x86::r11, 12)); // r.TopLeft.R1.Y
    a.mov(x86::ecx, x86::eax);
    a.mov(x86::rax, imm((uint64_t)&_jit_print_int));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    ...
    asm_out << "record_vars: times 40 db 0\n";
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"rX: \", 0\n";
    asm_out << "_str_1 db \"rY: \", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test18.asm" << std::endl;
    }
    
    std::array<int,      1> int_vars{};
    std::array<double,   1> double_vars{};
    std::array<char*,    1> string_vars{};
    std::array<uint8_t,  40> record_vars{};
