...
static const char str_0[] = "n1";
static const char str_1[] = "Nil pointer error: n1";
static const char str_2[] = "n2";
static const char str_3[] = "Nil pointer error: n2";
static const char str_4[] = "n3";
static const char str_5[] = "Nil pointer error: n3";
static const char str_6[] = "p";
static const char str_7[] = "Nil pointer error: p";
...
int main() {
    ...
    a.mov(x86::qword_ptr(x86::r11, 0), x86::rax); // n1
    a.mov(x86::rcx, 12);
    a.mov(x86::rax, imm((uint64_t)&_jit_new_memory));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::qword_ptr(x86::r11, 8), x86::rax); // n2
    a.mov(x86::rcx, 12);
    a.mov(x86::rax, imm((uint64_t)&_jit_new_memory));
    a.sub(x86::rsp, 32); // Windows x64 shadow space
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::qword_ptr(x86::r11, 16), x86::rax); // n3
    a.mov(x86::eax, 10);
    a.mov(x86::ebx, x86::eax);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // n1
    Label ptr_not_nil_1 = a.new_label();
    ...
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.bind(ptr_not_nil_1);
    a.mov(x86::dword_ptr(x86::rax), x86::ebx); // n1^.Value :=
    a.mov(x86::eax, 20);
    a.mov(x86::ebx, x86::eax);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 8)); // n2
    Label ptr_not_nil_2 = a.new_label();
    a.test(x86::rax, x86::rax);
    a.jnz(ptr_not_nil_2);
    ...
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.bind(ptr_not_nil_2);
    a.mov(x86::dword_ptr(x86::rax), x86::ebx); // n2^.Value :=
    a.mov(x86::eax, 30);
    a.mov(x86::ebx, x86::eax);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 16)); // n3
    Label ptr_not_nil_3 = a.new_label();
    a.test(x86::rax, x86::rax);
    a.jnz(ptr_not_nil_3);
    ...
    a.call(x86::rax);
    a.add(x86::rsp, 32);
    a.bind(ptr_not_nil_3);
    a.mov(x86::dword_ptr(x86::rax), x86::ebx); // n3^.Value :=
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 8)); // n2
    ...
    a.pop(x86::r11);
    a.mov(x86::qword_ptr(x86::rax), x86::r11); // n1^.Next :=
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 16)); // n3
    a.push(x86::rax); // save right pointer value
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    ...
    a.add(x86::rax, 4); // field offset
    a.pop(x86::r11);
    a.mov(x86::qword_ptr(x86::rax), x86::r11); // n2^.Next :=
    a.xor_(x86::rax, x86::rax); // nil
    a.xor_(x86::rax, x86::rax); // nil pointer
    a.xor_(x86::rax, x86::rax); // nil pointer
    a.push(x86::rax); // save right pointer value
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 16)); // n3
    a.add(x86::rax, 4); // field offset
    a.pop(x86::r11);
    a.mov(x86::qword_ptr(x86::rax), x86::r11); // n3^.Next :=
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 0)); // n1
    a.mov(x86::r11, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::qword_ptr(x86::r11, 24), x86::rax); // p
    Label while_4 = a.new_label();
    Label endwhile_5 = a.new_label();
    a.bind(while_4);
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 24)); // p
    ...
    a.mov(x86::rax, x86::qword_ptr(x86::r12, offsetof(JitContext, pointr_vars)));
    a.mov(x86::rax, x86::qword_ptr(x86::rax, 24)); // p
    Label ptr_not_nil_6 = a.new_label();
    a.test(x86::rax, x86::rax);
    a.jnz(ptr_not_nil_6);
    ...
    labels.add("L0", "ptr_not_nil_1");
    labels.add("L1", "ptr_not_nil_2");
    labels.add("L2", "ptr_not_nil_3");
    labels.add("L3", "while_4");
    labels.add("L4", "endwhile_5");
    labels.add("L5", "ptr_not_nil_6");
    ...
    asm_out << "pointr_vars: times 4 dq 0\n";
    ...
    asm_out << "\nsection .data\n";
    asm_out << "_str_0 db \"n1\", 0\n";
    asm_out << "_str_1 db \"Nil pointer error: n1\", 0\n";
    asm_out << "_str_2 db \"n2\", 0\n";
    asm_out << "_str_3 db \"Nil pointer error: n2\", 0\n";
    asm_out << "_str_4 db \"n3\", 0\n";
    asm_out << "_str_5 db \"Nil pointer error: n3\", 0\n";
    asm_out << "_str_6 db \"p\", 0\n";
    asm_out << "_str_7 db \"Nil pointer error: p\", 0\n";
    ...
    if (!write_formatted_asm_file(
        ...
        std::cerr << "Could not write ASM file: test31.asm" << std::endl;
    }
